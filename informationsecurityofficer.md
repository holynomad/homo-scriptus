...
## 2024-08-04
  ...
  Claude 3.5 soneet에게 남은 5일간의 벼락치기 전략을 물었다.
  아래와 같이 계획을 짜준다. (1일 5h x 5일)

  이렇든 저렇든, 벼락치기는 실행이 중요하다.
  ...
  ```
  네, 이해했습니다. 5일간 하루 5시간씩 집중적으로 공부하는 구체적인 타임테이블을 제안해 드리겠습니다.
  각 날짜별로 10시~12시, 14:30~17:30 시간대를 활용한 계획입니다.

  1일차:
  10:00-12:00: 시스템 보안 - 운영체제 보안 설정
  - 10:00-11:00: 윈도우 보안 설정
  - 11:00-12:00: 리눅스 보안 설정
  
  14:30-17:30: 네트워크 보안 - 기본 개념 및 주요 기술
  - 14:30-15:30: 방화벽 구성 및 설정
  - 15:30-16:30: IDS/IPS 개념 및 구현
  - 16:30-17:30: VPN 기술 및 구성 방법
  
  2일차:
  10:00-12:00: 어플리케이션 보안 - 웹 보안
  - 10:00-11:00: 웹 애플리케이션 취약점 유형
  - 11:00-12:00: OWASP Top 10 분석
  
  14:30-17:30: 정보보안 일반 - 암호화 및 인증
  - 14:30-15:30: 대칭키/비대칭키 암호화 알고리즘
  - 15:30-16:30: 해시 함수 및 전자서명
  - 16:30-17:30: 인증 프로토콜 (OAuth, SAML 등)
  
  3일차:
  10:00-12:00: 법규 및 관리
  - 10:00-11:00: 정보통신망법 주요 내용
  - 11:00-12:00: 개인정보보호법 주요 내용
  
  14:30-17:30: 시스템 보안 심화
  - 14:30-15:30: 윈도우 보안 강화 실습
  - 15:30-16:30: 리눅스 보안 강화 실습
  - 16:30-17:30: 로그 분석 및 모니터링 기법
  
  4일차:
  10:00-12:00: 네트워크 보안 심화
  - 10:00-11:00: 네트워크 공격 유형 분석
  - 11:00-12:00: 네트워크 보안 솔루션 구성
  
  14:30-17:30: 어플리케이션 보안 심화
  - 14:30-15:30: SQL 인젝션 대응 기법
  - 15:30-16:30: XSS 및 CSRF 방어 전략
  - 16:30-17:30: 안전한 인증 및 세션 관리
  
  5일차:
  10:00-12:00: 취약점 분석 및 모의해킹
  - 10:00-11:00: 취약점 스캐닝 도구 활용
  - 11:00-12:00: 모의해킹 시나리오 분석
  
  14:30-17:30: 종합 복습 및 문제 풀이
  - 14:30-15:30: 핵심 개념 총정리
  - 15:30-16:30: 기출문제 풀이
  - 16:30-17:30: 취약 영역 집중 보완
  
  추가 조언:
  1. 각 세션 사이에 10-15분 휴식을 취하세요.
  2. 공부한 내용을 즉시 요약하고 키워드를 정리하는 습관을 들이세요.
  3. 실제 시험 환경을 고려해 hand-on 실습을 많이 해보세요.
  4. 마지막 날에는 전체 영역을 빠르게 훑어보며 자주 출제되는 문제 유형을 체크하세요.
  5. 시험 전날은 과도한 학습보다는 충분한 휴식을 취하고 정리된 내용을 가볍게 복습하세요.
  
  이 계획을 따라 집중적으로 공부하시면 좋은 결과 있으실 거예요. 화이팅!
  ```
...
### 2024-08-07
  ...
  그래도 초기에 이비인후과 가서
  10년만의 엉덩이 주사와 약 5일치 받은건 선제 대응이었따.
...
### 2024-08-10
  ...
  * 단답형 (3 x 12문항)
  - linux 패스워드 최소 8자리 설정 : /etc/login.defs, min_passwd_len=8 ?
  - csma/ca 타임아웃 설정 신호 : SYN/ACK/RTS/CTS
  - DNS : authoritative, recursive
  - HTTP request smuggling
  - XSS 공격기법 3가지
  - slow read attack
  - xml 입력값 검증 및 조회 시 분석단계 보안약점 개선 3가지 : validators, 필터링, ?
  - 자산 / 위협 / 취약점
  - 위험관리 / 위험분석 / 보호대책 수립
  - 나머지 3개 기억 안남..

  * 서술형 (12 x 4문항)
  - 윈도우 사용자 계정 컨트롤 & 파일변경 시 관리자 암호 입력후 실행권한 화면 설명
  - PIA 개인정보 영향평가 시 고려해야 할 5가지
  - XSS 정의 및 공격기법 2가지
  - [device eth0 promiscuous mode]에 대한 설명, 어떤 공격인가 ? 해당 공격은 어떻게 대응 ?

  * 실무형 (16 x 2문항, 택1)
  - DBA 원격으로 열어주면 안되는 3가지 권한, 이를 위한 4가지 보호대책
  - OpenSSL Heartbleed 취약점 설명, 시스템적 대응 & 서비스관리적 대응

  생각보다 공부했던 영역에서 많이 나왔다.
  9/6 결과 발표보다
  9/7 SW 보안약점 진단원 시험 준비부터 시작할 예정.
